...
# 注意：当前代码是fork自fmz200作者，感谢原创作者的辛勤劳作，本人fork的目的仅自用，同时会添加一些自己发现的规则，也有可能在未来的时候自己写代码做规则
<br/>

> 本作者 077dwei 自行创建的和收集的规则代码将统一放在 d770MyRules 文件夹中

> 本人尊重原开发者的劳动成果。原开发者链接：https://github.com/fmz200/wool_scripts

> 当前 README.md 文件中的链接不会替换到本仓库，链接仍然保持连接到原作者的仓库，如果失效请手动添加本仓库的链接

> 当前仓库由我来维护，但是维护的力度不会很大
